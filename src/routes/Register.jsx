...
export default function Register() {
  ...
  const validateInputs = () => {
    ...
    if (!/[^\w]/.test(password)) {
      setPasswordError(true);
      setPasswordErrorMessage("Passwords must have at least one non-alphanumeric character.");
      isValid = false;
    }
    if (!/\d/.test(password)) {
      setPasswordError(true);
      setPasswordErrorMessage("Passwords must have at least one digit ('0'-'9').");
      isValid = false;
    }
    if (!/[a-z]/.test(password)) {
      setPasswordError(true);
      setPasswordErrorMessage("Passwords must have at least one lowercase ('a'-'z').");
      isValid = false;
    }
    if (!/[A-Z]/.test(password)) {
      setPasswordError(true);
      setPasswordErrorMessage("Passwords must have at least one uppercase ('A'-'Z').");
      isValid = false;
    }
    else {
